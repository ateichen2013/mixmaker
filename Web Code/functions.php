							...
							<div class="modal-body">
								...
								<div class="row">
                                    ...
                                    <div class="col-sm-6 div-slider">
                                        <input type="range" class="saveslider" id="slider1" value="' . $row['drink1'] . '" min="0" max="100" data-highlight="true" data-theme="a" data-disabled="true"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-3 text-right">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-sm-offset-3 text-center">
                                        <button class="btn btn-primary ui-btn ui-btn-g ui-shadow ui-corner-all" onclick="DeleteDrink(' . $row['drinkid'] . ')" data-theme="g">Delete</button>
                                    </div>
								</div>
								<div class="row">
                                    <div class="col-sm-6 col-sm-offset-3 text-center">
